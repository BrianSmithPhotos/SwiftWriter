...
Still to do: the editor inserts paragraphs and photographs, so headings, quotes, separators
and embeds reach a post only by being imported with it, and galleries render but nothing
creates them. Publishing has been done from the Mac and not yet tried from the iPad - the
